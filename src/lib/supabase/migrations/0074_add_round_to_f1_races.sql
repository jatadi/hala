...
-- Recreate the view with the round field
...
comment on view public.f1_races is 'Specialized view for F1 races with extracted metadata fields including round number';
